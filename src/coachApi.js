...
- Swings in power zone (EV >= 88 mph AND launch angle 25-35 degrees): ${s.swings.filter(sw => sw.hit.launch.exitSpeed >= 88 && sw.hit.launch.angle >= 25 && sw.hit.launch.angle <= 35).length} swings
